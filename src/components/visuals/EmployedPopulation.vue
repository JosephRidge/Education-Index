<template>
    <div>
      <h1>Kenya Total Employed Population by Sex and Age Group between 2015-2024</h1>
      <div class="chart">
  ...
  export default {
    setup() {
      ...
      async function loadCSVAndCreateChart() {
        const response = await fetch('visuals/total_employed_population.csv'); // Use the correct path to your CSV file
          ...
          options: {
            ...
            scales: {
              r: {
                ...
                title: {
                  display: true,
                  text: 'Total Employed Population',
                },
              },
            },
          },
