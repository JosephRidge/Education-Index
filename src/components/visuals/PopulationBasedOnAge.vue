<template>
  <div>
    <h1>Kenya Population Projection (Based on Age and Gender)  2015-2040</h1>
    <div class="chart">
...
export default {
  setup() {
    ...
    async function loadCSVAndCreateChart() {
      const response = await fetch('/visuals/population_based_on_age.csv'); // Use the correct path to your CSV file
